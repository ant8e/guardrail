    ...
    val implicits     = source"""
          ...
          object Implicits {
            ...
            object Show {
              ...
              implicit val showLocalDate: Show[java.time.LocalDate] = build[java.time.LocalDate](_.format(java.time.format.DateTimeFormatter.ISO_DATE))
              implicit val showOffsetDateTime: Show[java.time.OffsetDateTime] = build[java.time.OffsetDateTime](_.format(java.time.format.DateTimeFormatter.ISO_OFFSET_DATE_TIME))
              implicit val showJavaURL: Show[java.net.URI] = build[java.net.URI](_.toString)
              implicit val showUUID: Show[java.util.UUID] = build[java.util.UUID](_.toString)
            }
